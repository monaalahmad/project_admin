...
class UpdateCategoryController extends GetxController {
  ...
  Future<void> UpdateCategory(int categoryId, File image) async {
    loading.value = true;
    ...
    var request = http.MultipartRequest(
      'POST',
      Uri.parse('$baseUrl/api/employee/ElectronicShop/ProductClassification/updateProductClassification/$categoryId'),
    );
